...
export function ViewToggle({
  ...
  return (
    <div className="flex items-center gap-0.5 self-start rounded-full bg-card p-1 text-xs font-medium shadow-[0_1px_2px_rgba(32,36,45,0.04)] ring-1 ring-foreground/[0.06]">
      <Link
